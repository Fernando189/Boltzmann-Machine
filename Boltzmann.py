...
"""
Boltzmann Machine
Created on Sat Nov 27 16:25:38 2018
@author: Jose Fernando Nuñez
...
# Function that returns an architecture matrix based on clamped/unclamped units
...
def runAnnealing(W,V,K,F,T,numUnclamped): 
    """ Update h instead of V like in Navas code """
    counter = 0
...
numHidden = 24
# Initialize the 24 hidden units as 0
